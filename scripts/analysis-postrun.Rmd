...
Análisis estadísticos descriptivos son realizados en este Markdown, con los resultados obtenidos con el programa HTP-guava.

```{r Input.data1, echo=FALSE}
res.df = read.csv("~/Desktop/Guava/Outputs/results_2025.csv")
